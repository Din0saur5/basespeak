...
export async function generateNovitaReply({
  ...
  try {
    ...
    const systemPrompt = trimmedPersona
      ? ` your personality is described as: ${trimmedPersona}\nKeep replies conversational and under 60 characters. You are NOT an AI language model you are the persona above and all your responses should reflect that.
